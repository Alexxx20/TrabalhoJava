...
public class AlunoDAO {
    ...
    public static void addBanco(Aluno aluno) throws SQLException{
        ...
        String sql = "insert into kkk(numero, nome, materias) values (?, ?, ?)";
        PreparedStatement ps = con.prepareStatement(sql);
        ps.setInt(1, aluno.getNumero());
        ps.setString(2, aluno.getNome());
        ps.setString(3, aluno.getComputador());
        ps.execute();
    ...
    public static ArrayList<Aluno> pesquisarAll() throws SQLException{
        ...
        while(r.next()){
            ...
            a.setComputador(r.getString("materias"));
            list.add(a);
        }
    ...
    public static void deletar(int num) throws SQLException{
        ...
        String sql = "delete from kkk where numero = " + num;
        PreparedStatement ps = con.prepareStatement(sql);
        ps.executeUpdate();
